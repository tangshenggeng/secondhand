...
<body>
            ...
            <div class="container-fluid"  style="margin-top: 60px">
                ...
                <div class="row">
					<div class="col-lg-12">
						<form class="layui-form" id="kwCustForm">
							<div class="layui-inline layui-show-xs-block">
                                <input class="layui-input" autocomplete="off" id="start_date" placeholder="到期时间开始日" name="start_date" id="start" lay-key="1">
                            </div>
                            <div class="layui-inline layui-show-xs-block">
                                <input class="layui-input" autocomplete="off" id="end_date" placeholder="到期时间截止日" name="end_date" id="end" lay-key="2">
                            </div>
                            <div class="layui-inline layui-show-xs-block">
					...
					<br>
						...
						<button class="layui-btn layui-btn-normal" type="button" id="endVipBtn"><i class="layui-icon layui-icon-log"> 到期</i></button>
						<table id="custListTb"
		...
		layui.use(['table','util'], function() {
			...
			table.render({
				...
				cols : [ [ //表头
				{
					...
					align : "center",
					sort:true
					,templet:"<div>{{layui.util.toDateString(d.vipEnd, 'yyyy-MM-dd')}}</div>"
				}/* ,{
					fixed : 'right',
					title : '操作',
					toolbar : '#barDemo',
	...
	//批量异常
	$("#endVipBtn").click(function(){
		layui.use(['table','layer'], function() {
			var table = layui.table
			,layer = layui.layer;
			layer.confirm('确认用户到期了吗？', function(index){
				var checkStatus = table.checkStatus('custListTbId');
				var datas = checkStatus.data
				var ids = new Array();
				$(datas).each(function(){
