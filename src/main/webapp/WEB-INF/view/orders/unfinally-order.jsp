					...
					<div class="col-lg-12">
						<form class="layui-form" id="kwCustForm">
							<div class="layui-inline layui-show-xs-block">
                                <input class="layui-input" autocomplete="off" id="start_date" placeholder="下单时间" name="start_date" id="start" lay-key="1">
                            </div>
                            <div class="layui-inline layui-show-xs-block">
                                <input class="layui-input" autocomplete="off" id="end_date" placeholder="下单时间" name="end_date" id="end" lay-key="2">
                            </div>
                            <div class="layui-inline layui-show-xs-block">
...
<div style="display: none;" id="detailWareModal" align="center">
		<div class="layui-card">
			...
			<div class="layui-card-body">
				<h4>发布人：</h4>
				<div id="ownerModel" style="letter-spacing:3px"></div>
			</div>
			<div class="layui-card-body">
				<h4>购买人：</h4>
			...
			<div class="layui-card-body">
				<h4>联系方式：</h4>
				<div id="custEmailModal" style="letter-spacing:3px"></div>
			</div>
			<div class="layui-card-body">
				<h4>地址：</h4>
				<div id="custAddrModal" style="letter-spacing:3px"></div>
			</div>
			<div class="layui-card-body">
				<h4>快递公司：</h4>
				<div id="expressComModal" style="letter-spacing:3px"></div>
			</div>
			<div class="layui-card-body">
				<h4>快递单号：</h4>
				<div id="expressNumberModal" style="letter-spacing:3px"></div>
			</div>
			<div>
               <p>图片</p>
	...
	function renderTb() {
		...
		layui.use(['table','util'], function() {
			...
			table.render({
				elem : '#custListTb',
				height : 500,
				url : '${PATH}/order/getUnFinallyList',
				text : {
					none : '未找到商品'
				},
				id:"custListTbId",
			...
			table.on('tool(custListTbFilter)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
			  ...
			  if(layEvent === 'detail'){ //查看
				  $("#remarkModal").html(data.consigneeRemark)
				  $("#ownerModel").html(data.ownerNick)
				  $("#custModal").html(data.originatorNick)
				  $("#custEmailModal").html(data.consigneeEmail)
				  $("#custAddrModal").html(data.consigneeAddr)
				  $("#expressComModal").html(data.expressCom)
				  $("#expressNumberModal").html(data.expressNumber)
				  $("#imgOneModal").attr("src",data.wareImg)
